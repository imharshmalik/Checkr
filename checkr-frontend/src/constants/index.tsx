...
import adverseactionIcon from "../assets/images/adverse_action.svg";
import logsIcon from "../assets/images/logs.svg";
import analyticsIcon from "../assets/images/analytics.svg";
import accountIcon from "../assets/images/account.svg";
import screeningsIcon from "../assets/images/screening.svg";
...
export const GIF_HEADING = "Download link was sent to your email!!";
...
export const PRE_ADVERSE_CHECKBOX_3 =
  "Unable to verify employment history at XYZ";
...
export const AUTH0_DOMAIN = "dev-wp4xtazi5whmtqxa.us.auth0.com";
export const AUTH0_CLIENT_ID = "aDKZvf1LrJcO4HBxCazX8TMhJrj1RBnJ";
export const AUTH0_CALLBACK_URL = "http://localhost:300/callback";
export const VALID_EMAIL = "please enter a valid email";
export const VALID_PASSWORD =
  " password length should 8 character and contains(A,_,1)";
