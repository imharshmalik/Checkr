...
const mockUsersData = [
  ...
  },
  {
    ...
    firstName: "",
    lastName: "",
    email: "harsh.malik@zemosolabs.com",
    dob: "1990-06-20",
    companyName: "Checkr",
  },
  {
    ...
    jest.mock("@auth0/auth0-react", () => ({
      useAuth0: () => ({
        user: {
          ...
          name: "Harsh Malik",
          picture:
            "https://cdn.iconscout.com/icon/premium/png-512-thumb/manager-2595001-2165479.png?f=webp&w=256",
          locale: "en",
